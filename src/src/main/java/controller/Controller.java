...
public class Controller {
    ...
    public boolean emettiPrescrizioneSicura(Paziente paziente, Referto referto, Farmaco farmaco,int durata, String dosaggio) {
        ...
        Prescrizione nuovaPrescrizione = new Prescrizione( durata, dosaggio,null, farmaco);
